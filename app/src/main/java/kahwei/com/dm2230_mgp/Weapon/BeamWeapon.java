...
public class BeamWeapon extends Weapon
{
	public BeamWeapon(Resources r)
	{
		...
		m_weaponStates[0].Init(800,
				new ShotData(new Vector3(0.0f, -1000.0f, 0.0f), new Vector3(m_bulletTex[1]
						.getWidth() * 0.5f, 0.0f, 0.0f)));
		m_weaponStates[1].Init(800,
				new ShotData(new Vector3(0.0f, -1000.0f, 0.0f), new Vector3(0.0f, 0.0f, 0.0f)),
